            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="caption d-table">
                        <div class="d-table-cell align-middle">
                            <h1>Smart Digital Watches For Luxurious Life</h1>
                            <p>Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci. Aenean dignissim pellentesque felis.</p>
                            <a href="#product-area">Buy Our Watches</a>
                        </div>
                    </div>
                </div>
                <!--end caption content-->
                ...
                <div class="col-md-6">
                    <div class="caption-img text-right">
                        <img src="{{asset('images/watch-7.png')}}" class="img-fluid animation-jump" alt>
                    </div>
                </div>
                <!--end caption image-->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-img text-center">
                        <img src="{{asset('images/watch-8.png')}}" class="img-fluid animation-jump" alt="Image">
                    </div>
                </div>
                <!--end about image-->
                <!--start about info-->
...
@endsection('video-area')

<!-- End of vide0-area -->


<!-- Start of why choose us area -->
@section('why-chose-area')
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="product-gallery owl-carousel">
                        <img src="{{asset('images/watch-14.png')}}" class="img-fluid" alt>
                        <img src="{{asset('images/watch-15.png')}}" class="img-fluid" alt>
                        <img src="{{asset('images/watch-12.png')}}" class="img-fluid" alt>
                    </div>
                </div>
                <!--end product gallery-->
...
@endsection('why-chose-area')


<!-- End of why choose us area -->

<!-- Start of product area section -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="product-single row">
                        <div class="product-img text-center col-lg-6">
                            <img src="{{asset('images/watch-3.png')}}" class="img-fluid" alt="Image">
                        </div>
                ...
                <div class="col-md-6">
                    <div class="product-single row">
                        <div class="product-img text-center col-lg-6">
                            <img src="{{asset('images/watch-2.png')}}" class="img-fluid" alt="Image">
                        </div>
                        <div class="product-cont col-lg-6">
                ...
                <div class="col-md-6">
                    <div class="product-single row">
                        <div class="product-img text-center col-lg-6">
                            <img src="{{asset('images/watch-1.png')}}" class="img-fluid" alt="Image">
                        </div>
                        <div class="product-cont col-lg-6">
                ...
                <div class="col-md-6">
                    <div class="product-single row">
                        <div class="product-img text-center col-lg-6">
                            <img src="{{asset('images/watch-4.png')}}" class="img-fluid" alt="Image">
                        </div>
                        <div class="product-cont col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
                    <div class="section-heading text-center">
                        ...
                        <p class="text-white">Enter your email below to subscribe to our newsletter so you can get all new releases right in your mail box</p>
                    </div>
                </div>
            </div>
            <div class="row">
